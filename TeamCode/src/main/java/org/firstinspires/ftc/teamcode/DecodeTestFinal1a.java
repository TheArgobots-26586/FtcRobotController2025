...
@TeleOp(name="DecodeTestFinal1a", group="Robot")
public class DecodeTestFinal1a extends LinearOpMode {
...
//always shoot if there is a ball in shooting mode
                    // auto-fire while balls exist
                    if (firingEnabled && distanceCM < 7) {
