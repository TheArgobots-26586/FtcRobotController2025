...
@Autonomous(name = "FinalDecodeRedBack", group = "Robot")
public class FinalDecodeRedBack extends LinearOpMode {
...
//                })
                ...
                .turn(Math.toRadians(95))
                .back(23)
                .addTemporalMarker(() -> turret.setPosition(0.9))
                .waitSeconds(0.5)
                .addTemporalMarker(() -> {
                    LLResult result = limelight.getLatestResult();
                    if (result != null && result.isValid()) {
                ...
                .addTemporalMarker(() -> intake.setPower(INTAKE_COLLECT))
                .addTemporalMarker(() -> bootkicker.setPower(-0.4))
                .addTemporalMarker(() -> shooter.setVelocity(1450))
