...
@Autonomous(name = "RedBackAutonAsync", group = "Robot")
public class RedBackAutonAsync extends LinearOpMode {
    ...
    Range range4 = new Range(112, Integer.MAX_VALUE, 2150);
    ...
    public static final double BOOTKICKER_COLLECT = -0.3;
    ...
    public void runOpMode() {
        ...
        TrajectorySequence pickBalls_1 = drive.trajectorySequenceBuilder(new Pose2d(50, 12, Math.toRadians(180)))
                ...
                .lineToLinearHeading(new Pose2d(54, 12, Math.toRadians(190)))
                .build();
