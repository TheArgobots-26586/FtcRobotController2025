...
@Autonomous(name = "AllDecodeAutonsReverseCoords", group = "Robot")
public class AllDecodeAutonsReverseCoords extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d startPose = new Pose2d(-60, -12, 0);
        ...
        Pose2d startPoseBF = new Pose2d(60, -36, 0);
        drive.setPoseEstimate(startPoseBF);
        TrajectorySequence traj21BlueFront = drive.trajectorySequenceBuilder(startPoseBF)
                .addTemporalMarker(() -> {
                    shooter.setVelocity(1600);
                })
                .splineToLinearHeading(
                ...
                .splineToLinearHeading(new Pose2d(-12, -12, Math.toRadians(0)), Math.toRadians(0))
                .splineToLinearHeading(new Pose2d(60, -36, Math.toRadians(0)), Math.toRadians(0))
                .addTemporalMarker(() -> {
                    rotator.setPosition(0.67);//change as needed
                })
                .addTemporalMarker(() -> kicker.setPosition(0.8))
        ...
        TrajectorySequence traj22BlueFront = drive.trajectorySequenceBuilder(startPoseBF)
                .addTemporalMarker(() -> {
                    shooter.setVelocity(1600);
                })
                .splineToLinearHeading(
        ...
        TrajectorySequence traj23BlueFront = drive.trajectorySequenceBuilder(startPoseBF)
                .addTemporalMarker(() -> {
                    shooter.setVelocity(1600);
                })
                .splineToLinearHeading(
                ...
                .addTemporalMarker(() -> kicker.setPosition(0.33))
                .build();
        Pose2d startPoseRB = new Pose2d(12, -60, 0);
        drive.setPoseEstimate(startPoseRB);
        TrajectorySequence traj21RedBack = drive.trajectorySequenceBuilder(startPoseRB)
                .addTemporalMarker(() -> {
                    shooter.setVelocity(1600);
                })
                .splineToLinearHeading(
        ...
        TrajectorySequence traj22RedBack = drive.trajectorySequenceBuilder(startPoseRB)
                .addTemporalMarker(() -> {
                    shooter.setVelocity(1600);
                })
                .splineToLinearHeading(
        ...
        TrajectorySequence traj23RedBack = drive.trajectorySequenceBuilder(startPoseRB)
                .addTemporalMarker(() -> {
                    shooter.setVelocity(1600);
                })
                .splineToLinearHeading(
                ...
                .addTemporalMarker(() -> kicker.setPosition(0.33))
                .build();
        Pose2d startPoseRF = new Pose2d(60, 36, 0);
        drive.setPoseEstimate(startPoseRF);
        TrajectorySequence traj21RedFront = drive.trajectorySequenceBuilder(startPoseRF)
                .addTemporalMarker(() -> {
                    shooter.setVelocity(1600);
                })
                .splineToLinearHeading(
        ...
        TrajectorySequence traj22RedFront = drive.trajectorySequenceBuilder(startPoseRF)
                .addTemporalMarker(() -> {
                    shooter.setVelocity(1600);
                })
                .splineToLinearHeading(
        ...
        TrajectorySequence traj23RedFront = drive.trajectorySequenceBuilder(startPoseRF)
                .addTemporalMarker(() -> {
                    shooter.setVelocity(1600);
                })
                .splineToLinearHeading(
