...
@Autonomous(name = "DecodeAuton", group = "Robot")
public class ALL_DECODE_AUTONS extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence traj21BlueFront = drive.trajectorySequenceBuilder(startPose) //start position -12,60
                .addTemporalMarker(() -> {
                    shooter.setVelocity(1600);
                })
                .splineToLinearHeading(
