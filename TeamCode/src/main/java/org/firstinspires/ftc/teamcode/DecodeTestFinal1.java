...
@TeleOp(name="DecodeTestFinal1", group="Robot")
public class DecodeTestFinal1 extends LinearOpMode {
    ...
    public void runOpMode() {
      ...
      //  rotator = hardwareMap.get(Servo.class, "rotator");
        ...
        kicker.setPosition(0.33);//starting kicker value
        //  intake.setPower(0);
...
//            if (gamepad2.y && distanceCM < 6 && !kickerActive) {
//                kicker.setPosition(0.9);
//                kickerTimer.reset();
//                kickerActive = true;
//            }
//
//            if (kickerActive && kickerTimer.milliseconds() > 600) {
