...
@TeleOp(name="DECODE_TeleOp_FieldCentric", group="Robot")
public class DECODE_TeleoperatedV5 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // ---------- BALL DETECTION ----------
            boolean ballPresent =
                    ballSensor.getDistance(DistanceUnit.INCH)
            ...
            telemetry.addData("Ball Distance (in)",
                    ballSensor.getDistance(DistanceUnit.INCH));
